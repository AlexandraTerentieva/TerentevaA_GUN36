...
namespace Netologia.TowerDefence
{
    public class Tower : MonoBehaviour
    {
        ...
        public void LevelUp()
        {
            ...
            // ============================================================
            // ✅ ВЫЗЫВАЕМ OnUpgrade() У ВСЕХ КОМПОНЕНТОВ НА ОБЪЕКТЕ
            // Это нужно для казармы (BarracksSpawner) и других расширений
            // ============================================================
            SendMessage("OnUpgrade", SendMessageOptions.DontRequireReceiver);
        }
