...
namespace SampleProject
{
    public sealed class CommandController : MonoBehaviour
    {
        ...
        // Отправляет команду "Идти в точку" любому юниту (по Entity)
        // Используется в SelectionManager для движения группы
        [Button]
        ...
        // Отправляет команду "Атаковать цель" любому юниту (по Entity)
        // Используется в SelectionManager для атаки группы
        [Button]
        ...
        // Отправляет команду "Собрать ресурс" любому юниту (по Entity)
        // Используется в SelectionManager для сбора группы
        [Button]
